...
export default {
  ...
  data() {
    return {
      ...
      items: [
        { img: require("@/assets/images/icon/cat1.png"), title: "sport shoes" },
        {
        ...
        { img: require("@/assets/images/icon/cat4.png"), title: "flat" },
        { img: require("@/assets/images/icon/cat5.png"), title: "heels" },
        { img: require("@/assets/images/icon/cat6.png"), title: "boots" },
        {
          img: require("@/assets/images/icon/cat2.png"),
          title: "casual shoes",
        },
